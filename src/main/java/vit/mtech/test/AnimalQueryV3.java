...
//        String queryString=
//"SELECT DISTINCT ?product ?label ?value1 ?value2 ?product1 ?product2 ?product3 ?product4 ?product5 ?product6 ?type\n" +
//"WHERE { \n" +
//"    \n" +
...
//            + "?product rdfs:label ?label .\n"
//            + "};";
        QueryV3 m = new QueryV3(queryString);
